...
require_once 'tournaments/include/tournament_round.php';
 ...
 /*!
  * \class PrivateRoundRobinTournament
  *
  * \brief Template-pattern for official "Private Round-Robin"-tournament
  */
class PrivateRoundRobinTournament extends TournamentTemplateRoundRobin
{
   public function __construct()
   {
      ...
      parent::__construct( TOURNEY_WIZTYPE_PRIVATE_ROUNDROBIN,
         sprintf( T_('Private Round-Robin with %s participants, %s pools, %s rounds#tourney'),
            "$min_tp-$max_tp", "1-$max_pools", "1-$max_rounds" ),
         TOURNEY_TITLE_INVITE_ONLY|TOURNEY_TITLE_GAME_RESTRICTION );
   ...
   {
      global $player_row;
      $title = sprintf("%s's private mini-tournament (19x19)", $player_row['Handle']);
      $tourney = $this->make_tournament( TOURNEY_SCOPE_PRIVATE, $title );
...
} // end of 'PrivateRoundRobinTournament'
