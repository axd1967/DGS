...
/* Automatically generated at 2002-06-22 02:36:58 GMT */

class zh_big5_Language extends Language
{
  function zh_big5_Language()
    {
      $this->full_name = 'Chinese (Traditional)';
      $this->last_updated = 1024713418;
...
"如果您忘了密碼，我們將寄給您新的密碼。新的密碼是由亂數產生，但您稍後可由「編輯個人檔案」中更改。",
...
"更多資訊請參照<a href=\"phorum/list.php?f=3\">FAQ 論壇</a>，您可以在此提出問題。",
...
"歡迎進入龍之碁伺服器。這是一個<a href=\"licence.php\">免費</a>的<a href=\"links.php\">圍棋</a>伺服器。",
...
"您可以將這個伺服器看成是電子郵件對局，只是以網路介面使畫面看起來更美麗。要開始對局，您必須取得一個<a href=\"register.php\">帳號</a>；之後您可以編輯您的<a href=\"edit_profile.php\">個人資料</a>，還有您的<a href=\"edit_bio.php\">小傳</a>，特別是「開放對局」，「等級分」和「段級位」可以使您更容易找到對手。接下來您可以學習「<a href=\"users.php\">使用者列表</a>」和「<a href=\"phorum/index.php\">論壇</a>」來邀請適合您的對手。",
