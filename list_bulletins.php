...
*/
   ...
   if ( $view_edit )
      $btable->add_tablehead( 1, new TableHeadImage( T_('Edit Bulletin#bulletin'), 'images/edit.gif'), 'ImagesLeft', TABLE_NO_HIDE);
   ...
   $btable->add_tablehead(13, new TableHeadImage( T_('Information#bulletin'), 'images/info.gif'), 'ImagesLeft', 0);
