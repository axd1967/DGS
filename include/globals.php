...
define('DGS_VERSION', '1.19.0'); // ARCHITECTURE(1=php).MAJOR.MINOR
define('CSS_VERSION', '20141026223200'); // take UTC-timestamp of skins/dragon/screen.css
