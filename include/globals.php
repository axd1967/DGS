...
define('CSS_VERSION', '20131209040800'); // take UTC-timestamp of skins/dragon/screen.css
define('JS_VERSION',  '20131211002000'); // take UTC-timestamp of newest js/*.js script
